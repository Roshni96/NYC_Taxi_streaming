package project.taxistreaming

import project.taxistreaming.clustering.MainKmeans.prepareKmeansPipeline
import project.taxistreaming.processing.TaxiProcessing
import project.taxistreaming.utils.{ParseKafkaMessage, StreamingDataFrameWriter}
...
//--class package.taxistreaming.MainConsoleClustering --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.1
